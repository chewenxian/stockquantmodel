...
### 信源权重参考
- 官方公告（交易所/巨潮） = 最高权威，重点参考
- 四大证券报（中证/证券时报/上证/证券日报） = 高权威
- 主流财经媒体（财联社/东方财富/新浪） = 中等权威
- 社交媒体（雪球/股吧） = 低权威，需谨慎对待
- 如果低权威来源与高权威来源信息矛盾，优先采信高权威来源

注意：每个新闻的标题中用 [来源] 标注了信息来源，请据此判断权威性。

### 置信度惩罚规则（关键）
- 如果新闻数<3条，或信息不足以支撑判断，avg_sentiment必须设为接近0
- confidence不得高于实际掌握的信息量
- **宁愿给中性，绝不瞎猜**
- 合规要求：不得输出"保证涨停"、"内部消息"、"包赚不赔"等绝对性表述
"""
